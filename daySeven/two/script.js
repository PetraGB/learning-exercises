...
// var charIndex = 0;
//
// area.addEventListener("keydown", function(a) {
//     a.preventDefault(); // So pressed key char does not appear
//     textAdded += gettysburg[charIndex];
//     charIndex++;
//     area.value = textAdded;
// });
...
area.addEventListener("input", function() {
    ...
    var result = gettysburg.slice(0, typed.length);
    area.value = result;
});
